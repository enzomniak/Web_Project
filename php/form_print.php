    ...
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col d-flex justify-content-center" style="text-align: center; margin-top: 20px;">
                    <div>
                        ...
                        <h5>
                            Semester: <?= $re_enter_rad ?> Academic year: <?= $re_enter_acad_year ?>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-3">
                    <p>Student level: <?= $lvl_grad_rad ?></p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col d-flex justify-content-center">
                    <p><label for="middle_school_of">Study in/graduated from </label> <input type="text" id="middle_school_of" name="middle_school_of" size="50" value="<?= $schoolName ?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <p><?= $absence_rad ?> Semester <span>Academic Year : <?= $absence_acad_year ?></span></p>
                </div>
            </div>
