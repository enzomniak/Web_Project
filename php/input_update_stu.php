...
<html>
    ...
    <body>
        ...
        $sid = $_GET['sid'];
        $mainSql="SELECT * FROM student WHERE studentID = $sid";
        ...
        <form action="update_stu.php" method="post">
            ...
            <label for="abs_year">Absence-Date:</label> <input type="text" id="abs_year" name="abs_year" value="<?= $abs_year ?>">(Semester-Year)<br>
            <label for="phone">Phone:</label> <input type="text" id="phone" name="phone" value="<?= $phone ?>"><br>
            <label for="stu_lvl">Student Level:</label> <input type="text" id="stu_lvl" name="stu_lvl" value="<?= $stu_lvl ?>">
            <br>
